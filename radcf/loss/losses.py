"""Unless otherwise stated, this file is a modified version of https://github.com/bytedance/1d-tokenizer/blob/main/modeling/modules/losses.py
...
def hinge_d_loss(logits_real: torch.Tensor, logits_fake: torch.Tensor) -> torch.Tensor:
    ...
    See ./LICENSE_originals/LICENSE-taming-transformers for the original license.
    """
...
class ReconstructionLoss_Stage2(torch.nn.Module):
    def __init__(
        ...
        self.discriminator = NLayerDiscriminator(
            input_nc=loss_config.get("disc_in_channels", 3),
            n_layers=3,
            use_actnorm=False
        ).apply(weights_init)
