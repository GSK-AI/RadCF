"""
Unless otherwise stated, this file is a modified version of: https://github.com/facebookresearch/moco-v3/blob/main/vits.py
See ./LICENSE_originals/LICENSE-moco-v3 for the original license.
"""
...
def build_mlp(num_layers, input_dim, mlp_dim, output_dim, last_bn=True):
    """
    Copied from: https://github.com/facebookresearch/moco-v3/builder.py
    See ./LICENSE_originals/LICENSE-moco-v3 for the original license.
    """
    mlp = []
