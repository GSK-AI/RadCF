"""
This file is a modified version of https://github.com/hustvl/LightningDiT/blob/main/tokenizer/autoencoder.py
See ./LICENSE_originals/LICENSE-LightningDiT for the original license.
"""
...
class AutoencoderKL(nn.Module):
    def __init__(self, embed_dim, ch_mult, use_variational=True, in_channels=3):
        super().__init__()
        self.encoder = Encoder(ch_mult=ch_mult, z_channels=embed_dim, in_channels=in_channels)
        self.decoder = Decoder(ch_mult=ch_mult, z_channels=embed_dim, out_ch=in_channels)
